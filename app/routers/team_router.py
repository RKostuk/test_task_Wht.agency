...
from schemas.pySchemas import TeamDataSchema, TeamNameSchema, TeamUpdateDataSchema, ResponseSchema
...
@team_router.post('/create/', status_code=200, response_model=ResponseSchema)
...
@team_router.get('/info/', status_code=200, response_model=ResponseSchema)
...
@team_router.put('/update/', status_code=200, response_model=ResponseSchema)
...
@team_router.delete('/delete/', status_code=200, response_model=ResponseSchema)
